...
class Algebra(BoxLayout):
     ...
     def build(self):
          ...
          layout = GridLayout(cols=1, spacing=10, size_hint_y=1.25)
          ...
          frequency_title = Title('Formula for finding frequency', 'Formule pour trouver la fréquence', 'Формула для нахождения частоты', 'Հաճախականությունը գտնելու բանաձև', frequency_childrens_list)
